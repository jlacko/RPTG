...
\newcommand{\Paticka}{$if(version)$ {$version$} $endif$ $if(date)$ { $date$} $endif$} % patička - když verze tak verze, když datum tak datum; mezi tím mezera
...
\addto\captionsczech{\renewcommand{\figurename}{}} % Obrázek je pro děti...
